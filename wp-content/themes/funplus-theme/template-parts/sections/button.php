...
$class = get_sub_field('additional_class');
?>

<div class="custom-btn" style="margin: 25px; text-align:center;">
  <a href="<?php echo esc_url($btn['url']); ?>" class="btn btn-plus btn-primary btn-plus-white <?php echo $class; ?>" target="<?php echo esc_attr($btn['target']); ?>">
    ...
    <span class="btn__text"><?php echo $btn['title']; ?></span>
