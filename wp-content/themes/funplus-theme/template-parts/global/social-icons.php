...
$spotify = get_field('social_spotify', 'option');
...
<ul class="social-icons">
    ...
    <?php if (!empty($spotify)) : ?>
        <li>
            <a class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s" href="<?php echo esc_url($spotify); ?>" target="_blank">
                <?php get_template_part('template-parts/icons/spotify', null, ['color' => $color, 'alt_color' => $alt_color]); ?>
                <?php printf('<span class="label">%s</span>', $labels ? 'Spotify' : ''); ?>
            </a>
        </li>
    <?php endif; ?>
