...
function initMap(map_id) {
  ...
  var map = mapContainer.querySelector('.world-map__map'); // Highlight areas and show pin
...
$(document).ready(function () {
  ...
  function afterReveal(el) {
    if (!el.classList.contains('banner-statistics')) {
      ...
      statistics.style.opacity = 0; // countupEls.forEach((element) => {
